...
#### 2. 2024_Bioinformatics_scNODE (scNODE : GENERATIVE MODEL FOR TEMPORAL SINGLE CELL TRANSCRIPTOMIC DATA PREDICTION)
[文章地址](https://www.biorxiv.org/content/10.1101/2023.11.22.568346v2.full.pdf) | [代码地址](https://github.com/rsinghlab/scNODE)





#### 3. 2023_TMLR_OT-CFM (Improving and Generalizing Flow-Based Generative Models with Minibatch Optimal Transport)
